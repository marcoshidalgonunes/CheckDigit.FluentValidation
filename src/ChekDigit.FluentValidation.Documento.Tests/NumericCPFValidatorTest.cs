...
public class NumericCPFValidatorTest
{
    ...
    {
        // Arrange
        ObjectWithDocumentNumeric objectWithDocumentNumeric = new() { Documento = 12345678990 };
    ...
    {
        // Arrange
        ObjectWithDocumentNumeric objectWithDocumentNumeric = new() { Documento = 12345678909 };
        ObjectWithDocumentNumericValidator validator = new();
